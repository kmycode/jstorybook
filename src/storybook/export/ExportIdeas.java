...
import storybook.model.dao.IdeaDAOImpl;
...
public class ExportIdeas {
	...
	public String ligne(Idea obj, boolean verbose, boolean list) {
		String x=((IdeaState)obj.getIdeaState()).getName();
		String body[]={
			Long.toString(obj.getId()),
			((IdeaState)obj.getIdeaState()).getName(),
			//BookUtil.getIdeaStatus(obj.getStatus()),
			obj.getNotes()
		};
		switch(parent.format) {
			case "pdf":
