 ...
 *
 */
public class SafeCategoryComparator implements Comparator<Object> {
	...
	public int compare(Object o1, Object o2) {
		...
		if (o2 instanceof Category && !(o1 instanceof Category)) {
			return -1;
		}
		if (o1 instanceof Category && o2 instanceof Category) {
			CategoryComparator comp = new CategoryComparator();
			return comp.compare((Category) o1, (Category) o2);
		}
