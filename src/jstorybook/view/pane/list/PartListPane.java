 ...
 *
  * @author KMY
 */
public class PartListPane extends EntityListPane<Part> {

	public PartListPane (Messenger messenger) {
		super(ResourceManager.getMessage("msg.part"), EntityType.PART, messenger);
	}
