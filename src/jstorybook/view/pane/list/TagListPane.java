 ...
 *
  * @author KMY
 */
public class TagListPane extends EntityListPane<Tag> {

	public TagListPane (Messenger messenger) {
		super(ResourceManager.getMessage("msg.tag"), EntityType.TAG, messenger);
	}
