 ...
 * @author KMY
 */
public class AssociationChartShowMessage extends Message {

	private final ObjectProperty<Entity> entity = new SimpleObjectProperty<>();

	public AssociationChartShowMessage (Entity entity) {
		this.entity.set(entity);
	}

	public ReadOnlyObjectProperty<Entity> entityProperty () {
		return this.entity;
	}
