 ...
 */
public class Scene extends Entity implements Comparable<Scene> {
    ...
    public void setRelativeSceneId(Scene relativeScene) {
		...
		setRelativeSceneId(relativeScene.getId());
    }
...
//			return I18N.getMsg("msg.common.scene") + " [" + getTransientId() + "]";
    ...
    public boolean equals(Object obj) {
		...
		if (this.getId() != null ?  ! this.getId().equals(test.getId()) : test.getId() != null) {
            return false;
        }
        boolean ret = true;
