...
public class PartDAO extends DAO<Part> {
	...
	// データベースに対する操作
	@Override
	protected Part loadModel (ResultSet rs) throws SQLException {
		Part model = new Part();
	...
	@Override
	protected void saveModel (Part model) throws SQLException {
	...
	protected void createTable () throws SQLException {
		this.getStoryFileModel().updateQuery(
				"CREATE TABLE part (id INTEGER PRIMARY KEY NOT NULL, name TEXT NOT NULL, [order] INTEGER NOT NULL DEFAULT (1), note TEXT)");
	}
