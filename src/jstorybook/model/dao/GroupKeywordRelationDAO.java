 ...
 * @author KMY
 */
public class GroupKeywordRelationDAO extends EntityRelationDAO<GroupKeywordRelation> {
	...
	public void readGroupDAO (GroupDAO dao) {
		for (GroupKeywordRelation model : this.modelList.get()) {
	...
	@Override
	protected GroupKeywordRelation newEntityRelationInstance () {
		return new GroupKeywordRelation();
	}
