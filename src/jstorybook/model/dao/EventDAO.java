...
public class EventDAO extends DAO<Event> {
	...
	// データベースに対する操作
	@Override
	protected Event loadModel (ResultSet rs) throws SQLException {
	...
	@Override
	protected void saveModel (Event model) throws SQLException {
	...
	protected void createTable () throws SQLException {
		this.getStoryFileModel().updateQuery(
				"CREATE TABLE event (id INTEGER PRIMARY KEY NOT NULL, name TEXT NOT NULL, [order] INTEGER NOT NULL DEFAULT (1), starttime TEXT, endtime TEXT, note TEXT)");
	}
