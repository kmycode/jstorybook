 ...
 * @author KMY
 */
public class PlaceEventRelationDAO extends EntityRelationDAO<PlaceEventRelation> {
	...
	public void readGroupDAO (PlaceDAO dao) {
		for (PlaceEventRelation model : this.modelList.get()) {
	...
	@Override
	protected PlaceEventRelation newEntityRelationInstance () {
		return new PlaceEventRelation();
	}
