 ...
 * @author KMY
 */
public class PersonEventRelationDAO extends EntityRelationDAO<PersonEventRelation> {
	...
	public void readPersonDAO (PersonDAO dao) {
		for (PersonEventRelation model : this.modelList.get()) {
	...
	@Override
	protected PersonEventRelation newEntityRelationInstance () {
		return new PersonEventRelation();
	}
